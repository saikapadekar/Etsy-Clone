   ...
   this.state={
    ...
    render() {
      ...
      <div className="input-group">
        ...
        />
        <Button type="button" className={classes.button} onClick={this.checkAvailability}>
          Check Availability
        </Button>
      </div>
      </center>
...
export default connect(mapStateToProps, {createShop} )(withStyles(styles)(shopname))
